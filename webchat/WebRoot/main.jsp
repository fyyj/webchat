...
<script type="text/javascript" src="${ pageContext.request.contextPath }/js/jquery-1.8.3.js" charset="UTF-8"></script>
<script type="text/javascript" charset="UTF-8">
var sysBBS = "<span style='font-size:14px; line-height:30px;'>欢迎光临风云聊天室，请遵守聊天室规则，不要使用不文明用语。</span><br><span style='line-height:22px;'>";var sysBBS = "<span style='font-size:14px; line-height:30px;'>欢迎光临风云聊天室，请遵守聊天室规则，不要使用不文明用语。</span><br><span style='line-height:22px;'>";
	...
	<table width="778" height="95" border="0" align="center"
		...
		<form action="" id="form1" name="form1" method="post">
			...
			<tr>
				...
				<input name="to" type="text" value="" size="15" readonly="readonly">  说：
			...
			<tr>
				...
				<td colspan="2" align="center" >&nbsp;
					<font color="gray">ALL RIGHT RESERVED 风云依旧2018</font>
				</td>
				<td align="center">&nbsp;</td>
			</tr>
		</form>
